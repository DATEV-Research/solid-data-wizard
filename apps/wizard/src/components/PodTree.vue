...
<template>
  <Tree v-model:selectionKeys="selectedKey" @update:selection-keys="emits('update:selectedKeys',selectedKey)" @node-expand="emits('node-expand', $event)" :value="nodes" class="w-full md:w-30rem"
